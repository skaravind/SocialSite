...
<ul class="nav nav-tabs">
  <li role="presentation" class="active"><a href="welcome.php"><b>Home</b></a></li>
  <li role="presentation"><a href="timeline.php"><b>Timeline</b></a></li>
  <li role="presentation"><a href="profile/index.php"><b>Profile</b></a></li>
</ul>  
 
 <div class="writepost">
 <div class ="row">
 <div id ="pro-pic"><p><img src ="profile/images/<?php if(!empty($picture)){echo $rownamepic['picture'];} else { echo 'user.png';}?>"></p></div>
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action ="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
           ...
           <div class="form-group">
               <input type="text" name="tags" class="form-control" id="tags"  placeholder="Hashtags: #DigitalIndia #SocietyDevelopment">
           </div>
           <div class="form-group">
  ...
  <div class="form-group">
    ...
    <small id="fileHelp" class="form-text text-muted">Add image for visual impact. It's optional.</small>
  </div>
...
?>      
          ...
          <div class ="userpost">
		   ...
		   <p><img src ="profile/images/<?php if(!empty($pro_picture)){echo $row12['picture'] ;} else{ echo 'user.png';}?> "></p></a>
		   </div>
	...
	<div id="post-content" class="userpost"><p> <?php echo substr($content,0,200);?>... <a href ="pages.php?id=<?php echo $post_id ;?>"><span style="color:#808080;">[See More]</span></a></p>	    
		<div class ="row">
		    <div class="col-md-8 col-sm-8 col-xs-12 postbutton">
		    <h5 class="updw"><a class="upvote" datastatus="<?php echo $datastatus_up;?>" datatype="upvote" datavalue="<?php echo $post_id;?>"><b><?php echo $Upvote ;?></b><span class="badge"> &nbsp;&nbsp;<?php echo $row2[0] ;?></span></a>
			<a class="downvote" datastatus="<?php echo $datastatus_dw;?>"  datatype="downvote" datavalue="<?php echo $post_id;?>">&nbsp;&nbsp;<b><?php echo  $dwvote ;?></b><span class="badge"> &nbsp;&nbsp;<?php echo $row3[0];?></span</a>
			<a class="comment" href="pages.php?id=<?php echo $post_id ;?>"><b>&nbsp; &nbsp;Comments</b></a><h5>
			</div>
			
		  <div class="col-md-4 col-sm-4 col-xs-12 postsharebutton">
